...
# misc custom setting
batch_size = 64 * 4  # bs: total bs in all gpus
num_worker = 24
mix_prob = 0
clip_grad = 3.0
empty_cache = False
...
wandb_run_name = "sonata-pilarnet-pretrain-v6-4GPU-1m-256patch"  # Descriptive name for this run
...
hooks = [
    ...
    dict(type="CheckpointSaverIteration", save_freq=2500),
    # dict(type="PretrainEvaluator", write_cls_iou=True),
] 