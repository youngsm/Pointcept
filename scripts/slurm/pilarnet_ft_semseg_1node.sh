...
COMMAND="sh ${TRAIN_PATH} -m 1 -g 4 -d pilarnet -c semseg-sonata-pilarnet-ft -n sonata-pilarnet-semseg-ft-v1-4GPU-100ev-256patch-${CURRENT_DATETIME} -w exp/pilarnet/pretrain-sonata-pilarnet-100k-4GPU-2025-04-26_15-18/model/model_last.pth" # same as in SBATCH config!
